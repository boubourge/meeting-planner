...
Les check java fonctionnent bien mais la requête me retourne quand même les salles réservées. Je pense à un problème de format de date dans la requête générée par Hibernate car en testant la requête manuellement cela fonctionne.
